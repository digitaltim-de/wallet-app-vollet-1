...
import { ArrowLeft, Copy, QrCode, Trash2, AlertCircle, CheckCircle2, Eye, EyeOff, Key, Download, Upload, Database } from "lucide-react";
      ...
      <div className="min-h-screen bg-[#222222] text-white">
        ...
        <main className="container mx-auto p-4">
          <Card className="shadow-lg max-w-md mx-auto bg-[#2a2a2a] border-[#333333] text-white">
            <CardHeader>
              <CardTitle className="text-[#a99fec]">Wallet Security</CardTitle>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  <div className="bg-[#333333] p-2 rounded-lg text-sm font-mono flex-1 truncate text-gray-300">
                    {address}
                  </div>
                  <Button
                    variant="outline"
                    size="icon"
                    className="border-[#444444] hover:bg-[#333333] hover:text-[#a99fec]"
                    onClick={() => {
              ...
              {/* Private Key Section */}
              {privateKey && (
                <div className="space-y-2 border border-[#444444] p-3 rounded-lg bg-[#333333]">
                  <Label className="flex items-center text-gray-300">
                    <Key className="w-4 h-4 mr-1 text-[#a99fec]" />
                    Private Key
                  </Label>
                  <div className="relative">
                    <Input
                      ...
                      value={privateKey}
                      readOnly
                      className="font-mono pr-10 bg-[#222222] border-[#444444] text-gray-300"
                    />
                    <button
                      type="button"
        ...
        {showPassphraseModal && (
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50">
            <Card className="w-full max-w-md bg-[#2a2a2a] border-[#333333] text-white">
              <CardHeader>
                <CardTitle className="text-[#a99fec]">Enter Passphrase</CardTitle>
                <CardDescription className="text-gray-400">
            ...
            <Card className="w-full max-w-md bg-[#2a2a2a] border-[#333333] text-white">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="delete-passphrase" className="text-gray-300">Enter Passphrase to Confirm</Label>
                    <Input
